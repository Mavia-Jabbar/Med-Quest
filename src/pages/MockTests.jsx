  ...
  if (view === 'active') {
    ...
    return (
      <div className="flex-1 w-full flex flex-col h-full bg-white dark:bg-[#09090b] animate-in slide-in-from-bottom-8 duration-700">
        <header className="min-h-14 lg:min-h-16 border-b border-gray-200 dark:border-white/10 px-4 sm:px-6 flex flex-col sm:flex-row items-start sm:items-center justify-between shrink-0 bg-gray-50 dark:bg-black/50 backdrop-blur-md z-10 w-full py-3 sm:py-3 lg:py-0 gap-3 sm:gap-0">
           <div className="w-full sm:w-auto overflow-hidden">
             <h2 className="text-base sm:text-lg font-bold text-gray-900 dark:text-white truncate pr-2">{activeTest.title}</h2>
