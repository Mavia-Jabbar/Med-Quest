...
const Dashboard = () => {
  ...
  const analytics = [
    { subject: "Biology", score: getSubjectScore("Biology"), color: "bg-emerald-500", glow: "shadow-[0_0_10px_rgba(16,185,129,0.5)]" },
    { subject: "Chemistry", score: getSubjectScore("Chemistry"), color: "bg-blue-500", glow: "shadow-[0_0_10px_rgba(59,130,246,0.5)]" },
    { subject: "Physics", score: getSubjectScore("Physics"), color: "bg-red-500", glow: "shadow-[0_0_10px_rgba(239,68,68,0.5)]" },
  ];
